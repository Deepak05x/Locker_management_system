...
import { ArrowRight, Loader, BadgeAlert, BookOpen } from "lucide-react";
...
const TechnicalIssue = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await handleTechnicalIssue(subject, description);
        } catch (error) {
            console.log(error);
        } finally {
            setLoading(false);
                ...
                <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl">
                    <div className="text-center space-y-2 flex flex-col items-center gap-4">
                        ...
                        <h1 className="text-3xl flex flex-col font-bold text-blue-900">
                            Report An Technical <span>Issue</span>
                        </h1>
                    </div>
                    ...
                    <div className="mt-6 text-center">
                        <div className="space-y-2">
                            <p className="text-sm text-gray-600">
                                ...
                                <Link to={"/issue_reporting"} className="text-blue hover:underline cursor-pointer">
                                    Locker Issue
                                </Link>
                            </p>
                        </div>
